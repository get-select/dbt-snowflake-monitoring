...
select
    ...
    (all_queries.credits_used_cloud_services / nullif(credits_billed_daily.daily_credits_used_cloud_services, 0) * credits_billed_daily.daily_billable_cloud_services) * daily_rates.effective_rate as cloud_services_cost,
